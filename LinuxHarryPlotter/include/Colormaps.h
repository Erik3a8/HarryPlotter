...
Color RED_ORANGE[6] = {Color(102, 51, 0, "RGB"), Color(255, 128, 0, "RGB"), Color(204, 102, 0, "RGB"), Color(153, 0, 0, "RGB"), Color(51, 0, 0, "RGB"), Color(0,0,0, "RGB")};
double RED_ORANGE_POINTS[6] = {0, 0.17, 0.33, 0.67, 0.83, 1};

Color BLUE_PINK_BROWN[6] = {Color(160, 82, 45, "RGB"), Color(255, 0, 255, "RGB"), Color(138, 43, 226, "RGB"), Color(65, 105, 225, "RGB"), Color(25, 25, 112, "RGB"), Color(0,0,0, "RGB")};
